...
class WaterDetailsVC: UIViewController, MFMessageComposeViewControllerDelegate, CLLocationManagerDelegate {
    
    var waterDetail: Water?
    ...
    func loadDataFromPlist() {
        ...
        if let path = Bundle.main.path(forResource: "water", ofType: "plist") {
