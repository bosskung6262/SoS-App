...
class PoliceDetailsVC: UIViewController, MFMessageComposeViewControllerDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("Selected Index in viewDidLoad of PoliceDetailsVC: \(String(describing: selectedIndex))")
    ...
    func loadDataFromPlist() {
        ...
        if let path = Bundle.main.path(forResource: "police", ofType: "plist") {
