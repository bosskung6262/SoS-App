...
class TrafficDetailsVC: UIViewController, MFMessageComposeViewControllerDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("Selected Index in viewDidLoad of TrafficDetailsVC: \(String(describing: selectedIndex))")
    ...
    func loadDataFromPlist() {
        ...
        if let path = Bundle.main.path(forResource: "traffic", ofType: "plist") {
